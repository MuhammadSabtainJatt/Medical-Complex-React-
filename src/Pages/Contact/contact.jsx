    ...
    <div className="container maincontact">
      <div className="row">
        <div className="col">
          ...
          <p className='my-3'><Link className='text-danger ' style={{ textDecoration: "none" }}> Home </Link> <span> -  Contact US</span>
          </p>
          <hr />
        </div>
      </div>
      <div className="row my-4">
        <div className="col-12 col-md-6 bg-light rounded-4 border shadow text-center py-3 " >
          ...
          <div className="form1">
            ...
            <div className="row">
              <div className="col ">
                ...
                <div className="btn btn-danger ">Message</div>
              </div>
            </div>
          </div>
        </div>
